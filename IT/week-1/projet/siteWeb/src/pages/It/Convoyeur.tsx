      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Monitoring en temps réel - Groupe Innovators
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <StatCard
            ...
            value={totalWaste > 0 ? ((wasteCounts.recyclable / totalWaste) * 100).toFixed(1) : "0"}
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 mb-8">
          <h3 className="font-bold text-gray-800 mb-6 flex items-center gap-2">
            ...
            Répartition des Déchets en Temps Réel
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              />
              <ProgressBar
                percentage={totalWaste > 0 ? (wasteCounts.organic / totalWaste) * 100 : 0}
                color="bg-amber-500"
                height="h-3"
                showLabel={true}
                label="Organiques"
            ...
            <div className="space-y-4">
              <ProgressBar
                percentage={totalWaste > 0 ? (wasteCounts.electronic / totalWaste) * 100 : 0}
                color="bg-blue-500"
                height="h-3"
                showLabel={true}
                label="Électroniques"
              ...
              />
              <ProgressBar
                percentage={totalWaste > 0 ? (wasteCounts.residual / totalWaste) * 100 : 0}
                color="bg-red-500"
                height="h-3"
                showLabel={true}
                label="Résiduels"
        ...
        <div className="mb-8">
          <div className="bg-gradient-to-r from-slate-900 via-gray-800 to-slate-900 rounded-2xl p-8 text-white shadow-xl border border-gray-700">
            <div className="flex items-center justify-between mb-6">
              <div className="space-y-2">
                ...
                <p className="text-gray-400">
                  unités collectées et triées instantanément
                </p>
                <div className="flex items-center gap-2 text-emerald-400">
                  <TrendingUp className="w-4 h-4" />
                  <span className="text-sm">Performance en temps réel</span>
                </div>
              </div>
            ...
            <div className="mt-6 space-y-3">
              <div className="flex justify-between items-center text-sm">
                <span className="text-gray-300">Progression du tri</span>
                <span className="text-white font-bold">{totalWaste} / ∞</span>
              </div>
              <div className="bg-gray-700 rounded-full h-3 overflow-hidden">
                <div
                  className="h-3 bg-gradient-to-r from-emerald-500 via-blue-500 to-purple-500 rounded-full transition-all duration-1000"
                  style={{ width: `${Math.min((totalWaste / 100) * 100, 100)}%` }}
                />
              </div>
            </div>
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  {/* Barre de progression secondaire pour le volume */}
                  <div className="space-y-1">
                    ...
                    <div className="bg-gray-200 rounded-full h-1.5">
                      <div
                        className={`h-1.5 rounded-full transition-all duration-700 ${category.type === 'recyclable' ? 'bg-emerald-500' :
                          category.type === 'organic' ? 'bg-amber-500' :
                            category.type === 'electronic' ? 'bg-blue-500' : 'bg-red-500'
                          }`}
                        style={{
                          width: `${Math.min((category.count / Math.max(totalWaste, 1)) * 100, 100)}%`,
                          opacity: 0.6
                        }}
                      />
                    </div>
                ...
                <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-200">
                  <span className="text-xs text-gray-500">Cliquez pour trier</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-bold text-gray-800">Performance Environnementale</h3>
            </div>
            <div className="space-y-4">
              <div>
                <ProgressBar
              ...
              <div className="pt-2 border-t border-gray-100">
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span className={`font-semibold ${wasteCounts.residual < totalWaste * 0.3 ? 'text-green-600' : 'text-orange-600'}`}>
                    {wasteCounts.residual < totalWaste * 0.3 ? 'Excellent' : 'Bon'}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-bold text-gray-800">Informations Système</h3>
            </div>
            <div className="space-y-4">
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Efficacité système</span>
                  <span className="text-sm font-medium text-blue-600">{efficiency.toFixed(1)}%</span>
                </div>
                <ProgressBar
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-medium text-purple-600">{Math.min((totalWaste / 1000) * 100, 100).toFixed(1)}%</span>
                </div>
                <ProgressBar
                  percentage={Math.min((totalWaste / 1000) * 100, 100)}
                  color="bg-purple-500"
                  height="h-2"
                  animated={true}
                />
              ...
              <div className="pt-2 border-t border-gray-100 space-y-2">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600">Statut convoyeur</span>
