  ...
  const files: FileItem[] = [
    {
      ...
      file: "piece 1.pdf",
      type: "document",
      url: "/2025-Team-Innovators-Docs/output/piece 1.pdf",
    },
    {
      name: "Pièce 2",
      file: "piece 2.pdf",
      type: "document",
      url: "/2025-Team-Innovators-Docs/output/piece 2.pdf",
    },
    {
      name: "massePiece3",
      file: "massePiece3.pdf",
      type: "document",
      url: "/2025-Team-Innovators-Docs/output/massePiece3.pdf",
    },
     {
      name: "massePiece4",
      file: "massePiece4.pdf",
      type: "document",
      url: "/2025-Team-Innovators-Docs/output/massePiece4.pdf",
    },
    {
      name: "pincePositionMax",
      file: "pincePositionMax.pdf",
      type: "document",
      url: "/2025-Team-Innovators-Docs/output/pincePositionMax.pdf",
    },
    {
      name: "Assemblage pince",
      file: "assemblage pince.SLDASM",
      type: "document",
      url: "/2025-Team-Innovators-Docs/output/assemblage pince.SLDASM",
    },
    {
      name: "Pièce 1",
      file: "Piece1.SLDPRT",
