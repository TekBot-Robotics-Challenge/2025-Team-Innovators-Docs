        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
            ...
            {isOpen && (
                <div className="mt-4 space-y-1">
                    <a href="#introduction" className="block text-blue-600 hover:underline">1. Introduction</a>
                    <a href="#principes-de-base" className="block text-blue-600 hover:underline">2. Principes de base des capteurs</a>
                    <div className="ml-4 space-y-1">
                        <a href="#accelerometre" className="block text-blue-600 hover:underline">2.1. Accéléromètre</a>
                        <a href="#gyroscope" className="block text-blue-600 hover:underline">2.2. Gyroscope</a>
                    </div>
                    <a href="#presentation-mpu6050" className="block text-blue-600 hover:underline">3. Présentation du module MPU6050</a>
                    <a href="#schema-cablage" className="block text-blue-600 hover:underline">4. Schéma de câblage</a>
                    <a href="#installation-bibliotheques" className="block text-blue-600 hover:underline">5. Installation des bibliothèques</a>
                    <a href="#exemple-code" className="block text-blue-600 hover:underline">6. Exemple de code Arduino</a>
                    <a href="#usage-dmp" className="block text-blue-600 hover:underline">7. Usage du DMP et quaternions</a>
                    <a href="#simulation-wokwi" className="block text-blue-600 hover:underline">8. Simulation Wokwi</a>
                    <a href="#conclusion" className="block text-blue-600 hover:underline">9. Conclusion et perspectives</a>
                </div>
            )}
        </div>
    )
...
export const AccelerometerConcept = () => (
    <div className="bg-gradient-to-br from-blue-50 to-indigo-100 border border-blue-200 rounded-lg p-6 my-6">
        <h4 className="font-semibold text-blue-800 mb-3">Principe de fonctionnement</h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white p-4 rounded border">
                <div className="font-medium text-gray-800 mb-2">Au repos</div>
                <div className="text-sm text-gray-600">La bille repose sur la paroi Z (gravité = 1g)</div>
            </div>
            <div className="bg-white p-4 rounded border">
                <div className="font-medium text-gray-800 mb-2">En accélération</div>
                <div className="text-sm text-gray-600">La bille se déplace vers la paroi opposée</div>
            </div>
        </div>
    </div>
)
...
export const MPU6050Specs = () => (
    <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 my-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                <h4 className="font-semibold text-blue-600 mb-2">Caractéristiques générales</h4>
    ...
    <div className="overflow-x-auto my-6">
        <table className="min-w-full bg-white border border-gray-200 rounded-lg">
            ...
            <tbody className="divide-y divide-gray-200">
                <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 text-right">VCC</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">5V</td>
                </tr>
                <tr className="bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 text-right">GND</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">GND</td>
                </tr>
                <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 text-right">SDA</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">A4 (SDA)</td>
                </tr>
                <tr className="bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 text-right">SCL</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">A5 (SCL)</td>
                </tr>
                <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 text-right">AD0</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">non connecté (0x68) ou 3.3V pour 0x69</td>
                </tr>
            </tbody>
        </table>
    </div>
...
export const WokwiSimulation = () => (
    <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-lg p-6 my-6">
        <h3 className="font-bold text-green-800 mb-3">Testez en ligne sans matériel</h3>
        <p className="text-gray-700 mb-4">
            Utilisez la simulation Wokwi pour tester votre code avant de l'implémenter sur du matériel réel.
        </p>
        <a
...
export const FileLinks = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
        {[
            { name: "Sketch Arduino", file: "sketch.ino", type: "code" },
            { name: "Schéma KiCad", file: "fdv (2).kicad_sch", type: "schematic" },
            { name: "PDF du circuit", file: "fdv.pdf", type: "document" },
            { name: "Simulation virtuelle", file: "wokwi.gif", type: "media" }
        ].map((item, index) => (
            <div key={index} className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between">
                    ...
                    <div className={`px-2 py-1 rounded text-xs font-medium ${
                        ...
                        item.type === 'schematic' ? 'bg-green-100 text-green-700' :
                        item.type === 'document' ? 'bg-red-100 text-red-700' :
...
export const ResourceLinks = () => {
    const resources = [
        { title: "MPU6050 & Arduino", url: "https://randomnerdtutorials.com/arduino-mpu-6050-accelerometer-gyroscope/" },
        { title: "Tutoriel OLED & Arduino", url: "https://randomnerdtutorials.com/arduino-oled-display-ssd1306/" },
        { title: "Introduction aux capteurs MEMS", url: "https://www.electronics-tutorials.ws/io/io_7.html" },
        { title: "Documentation Arduino", url: "https://docs.arduino.cc/" },
        { title: "Bibliothèques Open Source", url: "https://github.com/Seeed-Studio/Seeed_Arduino_mpu6050" },
        { title: "Principes du DMP et quaternions", url: "https://www.invensense.com/wp-content/uploads/2015/02/AN-BNO080-01.pdf" },
        { title: "Projets DIY et Instructables", url: "https://instructables.com/tag/type-id/category-technology/" },
        { title: "Guides de programmation embarquée", url: "https://www.geeksforgeeks.org/embedded-systems/" }
    ]
    return (
        ...
        <div className="prose max-w-none">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 my-4">
                ...
                <ul className="text-blue-700 space-y-1">
                    <li>Le MPU6050 mesure l'accélération (X, Y, Z) et la rotation (X, Y, Z)</li>
                    <li>Interface I²C, deux adresses possibles (0x68 / 0x69)</li>
                </ul>
            </div>

            <h2 id="principes-de-base">Principes de base des capteurs</h2>
            <h3 id="accelerometre">Accéléromètre</h3>
            <p>Un accéléromètre mesure l'accélération linéaire. Voici le modèle conceptuel :</p>
            ...
            <ul>
                <li>En accélérant le cube de 1 g sur l'axe X, la bille appuie sur la paroi X</li>
                <li>Au repos sur Terre, la bille exerce 1 g sur la paroi Z, car la gravité agit en permanence</li>
            </ul>
            <AccelerometerConcept />
            <div className="bg-green-50 border-l-4 border-green-400 p-4 my-4">
                <div className="font-semibold text-green-800 mb-2">À retenir :</div>
                <ul className="text-green-700 space-y-1">
                    <li>La lecture d'un accéléromètre inclut l'accélération due à la gravité</li>
                    <li>Les capteurs MEMS utilisent la variation de capacité entre plaques pour mesurer la déflexion</li>
                </ul>
            </div>
            ...
            <h2 id="presentation-mpu6050">Présentation du module MPU6050</h2>
            <MPU6050Specs />
            <h4>Mesure de température</h4>
            <p>
                Le capteur embarque un thermomètre (-40 à +85°C, ±1°C). Il mesure la température de la puce pour compenser la dérive des capteurs, <b>pas</b> la température ambiante.
            </p>
            <h4>Bus I²C externe et 9 DOF</h4>
            <p>
                Deux broches (XDA, XCL) forment un bus I²C secondaire pour connecter un magnétomètre (ex : HMC5883L). Ainsi, on passe de 6 DOF à 9 DOF en mesurant le champ magnétique (X, Y, Z).
            </p>

            <h2 id="schema-cablage">Schéma de câblage Arduino ↔ MPU6050</h2>
            <WiringTable />

            <h2 id="installation-bibliotheques">Installation des bibliothèques</h2>
            <p>Installez via l'Arduino Library Manager :</p>
            <pre className="bg-gray-100 rounded p-4 overflow-x-auto"><code>
...
LiquidCrystal I2C by Frank de Brabander (≥ 1.1.4)
            ...
            <pre className="bg-gray-100 rounded p-4 overflow-x-auto"><code>{`#include <Wire.h>
...
void loop() {
    ...
    delay(100);
            ...
            <pre className="bg-gray-100 rounded p-4 overflow-x-auto"><code>{`void calibrateMPU() {
    const int N = 200;
    ...
    Serial.printf("Offsets: X=%.2f Y=%.2f Z=%.2f\n", offX, offY, offZ);
            ...
            <pre className="bg-gray-100 rounded p-4 overflow-x-auto"><code>{`float angleRoll=0;
...
String detectDirection(const sensors_event_t &a) {
    ...
    return String(angleRoll,1)+"°";
            ...
            <div className="bg-purple-50 border-l-4 border-purple-400 p-4 my-4">
                ...
                <p className="text-purple-700 mt-1">Combine rapidité du gyro et stabilité de l'accéléro.</p>
            </div>

            <h2 id="usage-dmp">Usage du DMP et quaternions</h2>
            <p>
                Le DMP interne du MPU6050 calcule directement quaternions et vecteurs d'orientation, déchargeant l'Arduino :
            </p>
            <pre className="bg-gray-100 rounded p-4 overflow-x-auto"><code>{`#include <MPU6050_6Axis_MotionApps20.h>
    ...
    if (mpu.dmpGetCurrentFIFOPacket(fifoBuffer)) {
        ...
        Serial.printf("Quaternion: w=%.3f x=%.3f y=%.3f z=%.3f\\n", q.w,q.x,q.y,q.z);
            ...
            <div className="bg-red-50 border-l-4 border-red-400 p-4 my-4">
                ...
                <p className="text-red-700 mt-1">Les quaternions évitent les problèmes de gimbal lock.</p>
            </div>

            <h2 id="simulation-wokwi">Simulation Wokwi</h2>
            <WokwiSimulation />

            <h2 id="fichiers-utiles">Fichiers utiles</h2>
            <FileLinks />

            <h2 id="conclusion">Conclusion et perspectives</h2>
            <Summary />
